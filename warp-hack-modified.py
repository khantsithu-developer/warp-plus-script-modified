...
print("[+} THIS SCRIPT MODIFIED BY KHANT SI THU")
print("[-] SITE: aliilapro.github.io")
print("[-] TELEGRAM: aliilapro")
print("--------")

print("===============  Example ================")
print(r"Users File : C:\Users\Acer\Desktop\vpn-users.txt")
print("GB To Get Per User : 100")
print("Seconds To Wait : 15")
print("=========================================\n")
try:
    filepath = input("Users File : ")
    gigabyte_to_steal = int(input("GB To Get Per User : "))
    seconds_to_wait = int(input("Seconds To Wait : "))
...
with open(filepath) as fp:
    ...
    while line:
        if c == 1:
            ...
            referrer = line.strip()
            for i in range(gigabyte_to_steal):
                os.system('cls' if os.name == 'nt' else 'clear')
                print("")
                print(
                    "    ALIILAPRO's WARP-PLUS-CLOUDFLARE (script)" + " Modified By Khant Si Thu")
                print("")
                ...
                if result == 200:
                    ...
                    print(
                        f"[:)] {g} GB has been successfully added to your account.")
